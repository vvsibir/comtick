...
namespace cSpeech
{
    ...
    public static class PCWin32 {
        ...
        //******************************
        [DllImport("winmm.dll")]
        public static extern int mixerGetID(int hmxobj, ref int pumxID, int fdwId);
    ...
    public class VMixer
    {
        ...
        public static int GetVolume()
        {
            ...
            //VolumeStructs.MixerCaps mc = new VolumeStructs.MixerCaps();

            //PCWin32.mixerGetDevCapsA(0, mc, Marshal.SizeOf(mc));


            //open the mixer
            var res = PCWin32.mixerOpen(out mixerControl, 0, 0, 0, VolumeConstants.MIXER_OBJECTF_MIXER);
